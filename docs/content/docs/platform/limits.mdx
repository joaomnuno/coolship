...
Coolship is verified against Coolify 4.3.23 (see [Server compatibility](/docs/concepts/server-compatibility)). The limits below hold independently of the version; each one is reported rather than papered over.
