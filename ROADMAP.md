...
- [x] Verbosity: normal, `--verbose`, `--debug`, and `COOLSHIP_VERBOSITY` for CI; `-v` stays version (request lines and full exchanges on stderr; names-only normal output elsewhere is tracked in #70).
