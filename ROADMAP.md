...
- [ ] Normal command output shows names only, and `--verbose` adds UUIDs and timings (the rest of #18, tracked in #70; the selectors item covers only the `link` and `init` choice).
