...
- The one-page site under `site/` and its GitHub Pages workflow are replaced by the documentation site under `docs/`; nothing is published to GitHub Pages anymore.
